...
class SmartTrashBinUI:
    def __init__(self, root):
        ...
        # Variabel Konfirmasi (Anti-Latah)
        self.objek_terakhir = None
        self.waktu_mulai_deteksi = 0
        self.durasi_konfirmasi = 5
        ...
        # 2. FRAME VIDEO (Tanpa batasan teks karakter)
    ...
    def init_hardware_and_ai(self):
        ...
        if self.model is None:
            try:
                self.lbl_status.config(text="Status: Memuat Model AI (Akselerasi OpenVINO)...", fg="orange")
                self.root.update()
    ...
    def start_system(self):
        ...
        # Buka Kamera dan paksa resolusinya (opsional)
        ...
        self.lbl_status.config(text="Status: SISTEM ONLINE (Pemilah & Anti-Latah Aktif)", fg="green")
    ...
    def update_frame(self):
        ...
        # ==========================================
        results = self.model.predict(source=frame, conf=0.6, show=False, verbose=False)
        ...
        # ==========================================
        # 3. RESIZE & CONVERT FRAME OPENCV KE TKINTER
        # ==========================================
        annotated_frame = results[0].plot()
        
        # Resize frame agar pas di UI (800x450 adalah rasio 16:9)
        ...
        # Panggil kembali fungsi ini setelah 15 ms
